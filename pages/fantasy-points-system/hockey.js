...
import { fetchHkypoints,  fetchPoints } from "../../services";
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="heading">
                                <h1>FANTASY POINTS SYSTEM HOCKEY</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                                                                    ...
                                                                                    >
                                                                                        <div className="points-body">
                                                                                            <div
                                                                                                ...
                                                                                                style={{
                                                                                                    backgroundImage: `url('/hockey.png')`,
                                                                                            ...
                                                                                            <div className="table-responsive">
                                                                                                <table className="table">
                                                                                                    <thead>
                                                                                                        {d.hky_fantasy_points
                                                                                                            .length
                                                                                                            ? d.hky_fantasy_points.map(
                                                                                                                (f) => {
                                                                                                                    return (
                                                                                                                        <tr>
                                                                                                                            <th scope="col">
