...
import { fetchBsbPoints, fetchbsbPoints, fetchPoints } from "../../services";
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="heading">
                                <h1>FANTASY POINTS SYSTEM BASEBALL</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                                                                        ...
                                                                                        <div className="points-body">
                                                                                            ...
                                                                                            <div className="table-responsive">
                                                                                                <table className="table">
                                                                                                    <thead>
                                                                                                        {d.bsb_fantasy_points
                                                                                                            .length
                                                                                                            ? d.bsb_fantasy_points.map(
                                                                                                                (f) => {
                                                                                                                    return (
                                                                                                                        <tr>
                                                                                                                            <th scope="col">
