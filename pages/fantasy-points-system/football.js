...
import { fetchFtbPoints, fetchPoints } from "../../services";
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="heading">
                <h1>FANTASY POINTS SYSTEM FOOTBALL</h1>
              </div>
            </div>
          </div>
        </div>
                                          ...
                                          >
                                            <div className="points-body">
                                              <div
                                                ...
                                                style={{
                                                  backgroundImage: `url('/football-banner.png')`,
                                                }}
                                              ></div>
                                              <div className="table-responsive">
                                                <table className="table">
                                                  <thead>
                                                    {d.ftb_fantasy_points
                                                      .length
                                                      ? d.ftb_fantasy_points.map(
                                                        (f) => {
                                                          return (
                                                            <tr>
                                                              <th scope="col">
